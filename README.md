...
## Phase 6.20〜6.22で強化したこと

- Review Watchの詳細一覧を折りたたみ前提へ変更
- 今日見るところ、重要アラート、統合サマリー、更新ハブを先に表示
- 鮮度、PR/CI統合説明、レーン、全件カードは必要な時だけ開く
- 画面を見る負担を減らし、manual / blocked だけに集中できる導線

## Phase 7入口で固定したこと

- 書き込み自動化に入る前に安全ゲートを表示
- Issue / PR本文の下書き生成は自動候補
- PR / CI / Review状態の読み取りは自動候補
- Issue作成、PR作成、マージは当面手動ゲート
